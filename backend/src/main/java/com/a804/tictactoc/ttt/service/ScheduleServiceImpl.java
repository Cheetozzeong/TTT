...
import com.a804.tictactoc.ttt.db.repository.ConfigRepo;
...
//                                "ckIc3tMUQV-JHJ6vtIogNd:APA91bEGOJT4Ov4mwhdV42yxohXlTDm1mj8Tn5R8YjzS3gA4mwZc2epEdDXNeIuW4CdMgAaSFaeZPZKmnOu-NpgVzvKyuoEsdUSkD3ocSNAE_tbCmiswFp2P7-JyWNKTpJZEQUpAQe70"
                            ...
                            //실패
                            SendPush(habit.getEmoji(),habit.getName() + "할 시간입니다.",selectedUser.getWatchDeviceToken());
                        }
    ...
    public boolean SendPush(String title, String sendMessage, String deviceToken){
        boolean result = true;
